...
import spring_boot from './spring_boot.png';
import spring_security from './spring_security.png';
...
export const infoList = [
    ...
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Turning ideas into problem-solving projects' }
];

export const toolsData = [
    assets.vscode,assets.eclipse,assets.intellij_idea, assets.mysql, assets.postman, assets.git, assets.canva
];